...
export default function ContactFormAlert({ state }: Props) {
  ...
  return (
    <div
      role="alert"
      className="absolute -inset-4 bg-white/95 z-10 animate-fade-in flex flex-col items-center justify-center"
    >
      {state === "success" ? (
        <>
        ...
        <>
          ...
          <p className="text-center max-w-sm">
            Aus technischen Gründen konnte Ihre Nachricht nicht zugestellt
