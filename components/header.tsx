    ...
    <>
        ...
        <ul className="mx-auto flex max-w-7xl justify-end gap-8 px-4">
          <li>
            <a
              ...
              className="inline-flex items-center gap-2 py-2 text-xs font-medium uppercase transition-transform duration-300 ease-in-out sm:text-sm md:px-0"
            >
      ...
      >
        <div className="relative mx-auto flex max-w-7xl flex-col items-center justify-center px-4 transition-all">
          ...
          <nav
            className={cn(
              "fixed bottom-0 right-0 flex flex-col bg-secondary-950 px-4 py-4 transition-all duration-300 ease-in-out md:visible md:static md:top-0 md:w-full md:translate-x-0 md:flex-row md:items-center md:justify-center md:gap-12 md:border-none md:bg-transparent md:px-0",
              {
          ...
          >
            <Link
              href="/#die-huette"
              className="px-8 py-2 text-sm font-medium uppercase transition-transform duration-300 ease-in-out md:px-0"
            >
              Die Hütte
            </Link>
            <Link
