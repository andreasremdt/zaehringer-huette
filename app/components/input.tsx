...
export default function Input({
  ...
  return (
    <div className={cn("relative", className)}>
      <input
        id={id}
        className="peer h-10 w-full rounded-lg border border-stone-300 bg-white px-4 text-sm text-stone-600 transition-colors hover:border-stone-400 focus:border-stone-600 focus:outline-none md:h-12 md:text-base"
        placeholder=" "
        required={required}
        {...props}
      />
